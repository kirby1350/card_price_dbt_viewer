...
export async function GET(
  ...
  try {
    ...
    type CardEntry = {
      ...
      rarity_name: string
      image_url: string | null
      prices: Array<{ shop: string; price: number | null; quantity: number | null; url: string | null; condition: string | null; crawled_at: string | null }>
    }
    ...
    return NextResponse.json({ error: '获取卡牌数据失败', detail: String(error) }, { status: 500 })
  }
}
